...
<section id="invest-ftx">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <h1 class="section__heading py-4 mb-4"><span class="c-violet">{{__("APY staking")}}</span></h1>
            </div>
        </div>
        <form action="{{route('cabinet.deposits.store')}}" method="POST">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    @include('cabinet.new.deposits._stakingCurrencySelect')
                </div>
            </div>
            <div class="row">
            ...
            <div class="row mb-4">
                ...
                <div class="col-md-6">
                    <div class="time-helper choose-helper my-md-0 my-4">
                        ...
                        <div class="choose-helper__item time-helper__item">
                            <button data-time="240" class="choose-helper__btn time-helper__btn">240 {{__("days")}}</button>
                        </div>
                    </div>
                </div>

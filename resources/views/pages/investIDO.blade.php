            ...
            <div class="investments-intro__row">
                <div class="investments-intro__col">
                    <div class="investments-intro__content">
                        <h1 class="investments-intro__title title"><span class="color-primary">{{__("Investing")}} </span> {{__("in IDO")}}</h1>
                ...
                <form>
                    <div class="calculate__block-row">
                        <div class="calculate__block-col">
                            ...
                            <a href="{{route('investplan.ido')}}" class="btn btn--primary-gr calculate__btn">{{__("Invest now")}}</a>
                        </div>
                        <div class="calculate__block-col">
        ...
        <div class="container">
            <div class="trading-bot__row">
                <div class="trading-bot__content">
                    <h2 class="trading-bot__title title"><span class="color-primary">{{__("Why is it important")}} </span> {{__("and what is IDO")}}</h2>

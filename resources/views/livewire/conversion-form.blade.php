<div data-v-0297da3b="" class="grid-column-12 grid-column-6--xl grid-column-start-4--xl padding-bottom-5">
    ...
    <p data-v-0297da3b="" class="color-gray font-sm margin-bottom-5"> {{__("conversion_details")}} </p>
    <div data-v-0297da3b=""  style="border: 1px solid rgba(34, 34, 34, 0.07);max-width: 500px" class="margin-bottom-7 bg-light p-3 border-rounded-6 w-75 m-auto  conversion d-flex flex-column relative">
        <div data-v-0297da3b="" style="background: rgb(241,241,241);" class=" p-3 border-rounded-3 grid-column-12 grid-column-5--md">
            <span data-v-0297da3b="" class="flex font-sm color-gray font-medium margin-bottom-1"> {{__("You pay")}} </span>
            <div data-v-0297da3b="" class="flex " >
                <div data-v-7f923647="" data-v-0297da3b="" data-vv-as=" " class="field flex-grow field--left"><!---->
                    <div data-v-7f923647="" class="relative">
                        <div data-v-7f923647="" >
                            <input data-v-7f923647="" class="bg-transparent font-xl" wire:model="amount" id="input_7g3417wn" name="amount_one" autocomplete="" type="text" placeholder="{{__("Exchange amount")}}">
                        </div>
                ...
                <div data-v-fa5ceebe="" data-v-0297da3b="" class="sticky-select--right sticky-select">
                    <select wire:model="currencyOne" class="h-100 border-rounded-max px-2"   name="currency_one">
                        ...
                        @elseif(($currencyOne == \App\Account::CURRENCY_USDT ||
            ...
            <div data-v-0297da3b="" class="font-sm color-gray margin-top-2"> {{__("Balans:")}} {{ $oneBalance }} {{ $currencyOneName }}</div>
        </div>
        ...
        <div data-v-0297da3b="" style="background: rgb(241,241,241);" class="p-3 border-rounded-3 grid-column-12 grid-column-5--md">
            <span data-v-0297da3b="" class="flex font-sm color-gray font-medium margin-bottom-1"> {{__("You recive")}} </span>
            <div data-v-0297da3b="" class="flex">
                <div data-v-7f923647="" data-v-0297da3b="" data-vv-as=" " class="field flex-grow field--left">
                    <div data-v-7f923647="" class="bg-transparent font-xl overflow-hidden">
                        <div data-v-7f923647="" class="">{{ $converted }}</div>
                    </div>
                </div>
                <div data-v-fa5ceebe="" data-v-0297da3b="" class="sticky-select--right sticky-select">
                    <select wire:model="currencyTwo" class="h-100 border-rounded-max px-2"  name="currency_two">
                        @if($currencyOne != \App\Account::CURRENCY_USDT &&
                            ...
                            <option value="{{\App\Account::CURRENCY_APY}}">APY</option>
                            <option value="{{\App\Account::CURRENCY_RUB_ACC}}">RUB</option>
                        @elseif(($currencyTwo == \App\Account::CURRENCY_USDT ||
                            $currencyTwo == \App\Account::CURRENCY_BUSD ||
                            $currencyTwo == \App\Account::CURRENCY_USDC ||
                            $currencyTwo == \App\Account::CURRENCY_RUB_ACC) && 
                            $currencyOne == \App\Account::CURRENCY_APY
            ...
            <div data-v-0297da3b="" class="font-sm color-gray"> {{__("Balans:")}} {{ $twoBalance }} {{ $currencyTwoName }}</div>
            <div data-v-0297da3b="" class="d-flex gap-1">1 {{ $currencyOneName }} =
                <div data-v-0297da3b="" class=""> {{ number_format($currencyRate,5) }}
        ...
        <button data-v-141d1a81="" wire:click="$emit('convert')" type="button" data-v-0297da3b="" @if(! $isCanChange) disabled @endif class="width-full margin-top-2 button button--primary @if(! $isCanChange) button--disabled @endif button--mini">

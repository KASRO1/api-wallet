                                            ...
                                            <div data-v-2eb02792="" class="grid-column-12 grid-column-6--md mt-3">
                                                <button data-v-141d1a81="" data-v-2eb02792="" class="width-full button button--primary button--mini">
                                                    <span data-v-141d1a81="" class="button__content">
                                                        ...
                                                        <?php if(! auth()->user()->is2FA): ?> <?php echo e(__("Activate")); ?> <?php else: ?> <?php echo e(__("Deactivate")); ?> <?php endif; ?>
                                                    </span>
                                                </button>
                                            </div>
                                        </form>
...
<?php echo $__env->make('layouts.cabinet', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/nikita/PhpstormProjects/api-wallet/resources/views/cabinet/new/password.blade.php ENDPATH**/ ?>
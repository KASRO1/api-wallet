            ...
            <div class="investments-intro__row">
                <div class="investments-intro__col">
                    <div class="investments-intro__content">
                        <h1 class="investments-intro__title title"><span class="color-primary"><?php echo e(__("Classic Staking")); ?></h1>
                        <div class="investments-intro__description">
                            <p><?php echo e(__("invest1")); ?> </p>
                        </div>
                    </div>
                </div>
                <div class="investments-intro__col">
                    <div class="investments-intro__earn">
                        ...
                        <p class="investments-intro__earn-value"><?php echo e(__("apy_Classic")); ?></p>
                ...
                <form>
                    <div class="calculate__block-row">
                        <div class="calculate__block-col">
                            ...
                            <p class="calculate__block-value"><?php echo e(__("apy_Classic")); ?></p>
                            <a href="<?php echo e(route('investplan.stock')); ?>" class="btn btn--primary-gr calculate__btn"><?php echo e(__("Invest now")); ?></a>
                        </div>
                        <div class="calculate__block-col">
        ...
        <div class="container">
            <div class="trading-bot__row">
                <div class="trading-bot__content">
                    <h2 class="trading-bot__title title"><span class="color-primary"><?php echo e(__("What is staking?")); ?> </span></h2>
                    <div class="trading-bot__text typography">
                        
                        <p><?php echo __("invest2"); ?></p>
                        <p style="font-size: 120%; font-weight: 700;"><?php echo __("invest3"); ?></p>
                        <p><?php echo __("invest4"); ?></p>
                        <p><?php echo __("invest5"); ?></p>
                    </div>
...
<?php echo $__env->make('layouts.front_app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/www-root/data/www/apy-wallet.com/resources/views/pages/classicstaking.blade.php ENDPATH**/ ?>
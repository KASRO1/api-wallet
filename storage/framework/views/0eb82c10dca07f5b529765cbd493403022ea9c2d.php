...
<section id="invest-ftx">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <h1 class="section__heading py-4 mb-4"><span class="c-violet"><?php echo e(__("Liquidity pools")); ?></span></h1>
            </div>
        </div>
        <form action="<?php echo e(route('cabinet.deposits.store')); ?>" method="POST">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <?php echo $__env->make('cabinet.new.deposits._liquidityCurrencySelect', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                </div>
            </div>
            <div class="row">
            ...
            <div class="row mb-4">
                ...
                <div class="col-md-6">
                    <div class="time-helper choose-helper my-md-0 my-4">
                        ...
                        <div class="choose-helper__item time-helper__item">
                            <button data-time="15" class="choose-helper__btn time-helper__btn active">15 <?php echo e(__("days")); ?></button>
                        </div>
                        <div class="choose-helper__item time-helper__item">
                            <button data-time="30" class="choose-helper__btn time-helper__btn">30 <?php echo e(__("days")); ?></button>
                        </div>
                        <div class="choose-helper__item time-helper__item">
                            <button data-time="60" class="choose-helper__btn time-helper__btn">60 <?php echo e(__("days")); ?></button>
                        </div>
                        <div class="choose-helper__item time-helper__item">
                            <button data-time="90" class="choose-helper__btn time-helper__btn">90 <?php echo e(__("days")); ?></button>
                        </div>
                        <div class="choose-helper__item time-helper__item">
                            <button data-time="120" class="choose-helper__btn time-helper__btn">120 <?php echo e(__("days")); ?></button>
                        </div>
                    </div>
                </div>
                <div class="col-md-12 mt-4 profit-calculate">
                    <div class="profit-calculate-box">
                        ...
                        <p data-timeframe="d" data-currency="APY">0</p>
                    </div>
                    <div class="profit-calculate-box">
                        <span><?php echo e(__("Monthly Profit")); ?>:</span>
                        <p data-timeframe="m" data-currency="APY">0</p>
                    </div>
                    <div class="profit-calculate-box">
                        <span><?php echo e(__("Yearly Profit")); ?>:</span>
                        <p data-timeframe="y" data-currency="APY">0</p>
                    </div>
                </div>
            </div>
            <div class="row">
...
<?php echo $__env->make('cabinet.new.deposits._profitCalcLiquidity',['accounts' => $user->accounts,'percent'=>$depositDetails['percent'],'rates'=>$rates], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.cabinet', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/www-root/data/www/apy-wallet.com/resources/views/cabinet/new/deposits/liquiditypools.blade.php ENDPATH**/ ?>
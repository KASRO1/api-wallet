            ...
            <div class="investments-intro__row">
                <div class="investments-intro__col">
                    <div class="investments-intro__content">
                        <h1 class="investments-intro__title title"><span class="color-primary"><?php echo e(__("Staking")); ?> </span> <?php echo e(__("APY token")); ?></h1>
                        <div class="investments-intro__description">
                            <p><?php echo e(__("APY_info1")); ?> </p>
                        </div>
                    </div>
                </div>
                <div class="investments-intro__col">
                    <div class="investments-intro__earn">
                        ...
                        <p class="investments-intro__earn-value"><?php echo e(__("apy_sAPY")); ?></p>
                        ...
                        <div class="calculate__block-col">
                            <div class="calculate__field field"><label class="calculate__label">Currency</label>
                                <div class="field-payment">
                                    <div class="field-payment__icon"><img src="<?php echo e(asset('assets/images/currency/APY.png')); ?>" alt=""></div>
                            ...
                            <p class="calculate__block-value"><?php echo e(__("apy_sAPY")); ?></p>
                            <a href="<?php echo e(route('investplan.isolated')); ?>" class="btn btn--primary-gr calculate__btn"><?php echo e(__("Invest now")); ?></a>
                        </div>
                        <div class="calculate__block-col">
            ...
            <div class="trading-bot__row">
                <div class="trading-bot__content">
                    <h2 class="trading-bot__title title">
                        <span class="color-primary"><?php echo e(__("Advantages of staking")); ?> </span> <?php echo e(__("APY token")); ?>

                    </h2>
                    <div class="trading-bot__text typography">
                        <p><?php echo __("APY_info2"); ?></p>
                        <p><?php echo __("APY_info3"); ?></p>
                        <p><?php echo __("APY_info4"); ?></p>
                        <p><?php echo __("APY_info5"); ?></p>
                    </div>
...
<?php echo $__env->make('layouts.front_app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/www-root/data/www/apy-wallet.com/resources/views/pages/staking.blade.php ENDPATH**/ ?>
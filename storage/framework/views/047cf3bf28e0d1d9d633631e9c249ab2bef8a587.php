            ...
            <div class="investments-intro__row">
                <div class="investments-intro__col">
                    <div class="investments-intro__content">
                        <h1 class="investments-intro__title title"><span class="color-primary"><?php echo e(__("DeFi staking")); ?> </span></h1>
                        <div class="investments-intro__description">
                            <p><?php echo e(__("TP_info1")); ?> </p>
                        </div>
                    </div>
                </div>
                <div class="investments-intro__col">
                    <div class="investments-intro__earn">
                        ...
                        <p class="investments-intro__earn-value"><?php echo e(__("apy_DeFi")); ?></p>
                            ...
                            <div class="calculate__field field"><label class="calculate__label">Currency</label>
                                <div class="field-payment">
                                    ...
                                    <select class="js-select-payment" name="currency" id="PSys">
                                        <option value="AVAX" data-icon-src="<?php echo e(asset('assets/images/currency/AVAX.png')); ?>">
                                            AVAX
                                        </option>
                                        <option value="KAVA" data-icon-src="<?php echo e(asset('assets/images/currency/KAVA.png')); ?>">
                                            KAVA
                                        </option>
                                        <option value="UNI" data-icon-src="<?php echo e(asset('assets/images/currency/UNI.png')); ?>">UNI
                                        </option>
                                        <option value="DAI" data-icon-src="<?php echo e(asset('assets/images/currency/DAI.png')); ?>">DAI
                                        </option>
                                        <option value="LINK" data-icon-src="<?php echo e(asset('assets/images/currency/LINK.png')); ?>">LINK
                                        </option>
                                        <option value="GRT" data-icon-src="<?php echo e(asset('assets/images/currency/GRT.png')); ?>">GRT
                                        </option>
                                        <option value="DYDX" data-icon-src="<?php echo e(asset('assets/images/currency/DYDX.png')); ?>">DYDX
                                        </option>
                                        <option value="DODO" data-icon-src="<?php echo e(asset('assets/images/currency/DODO.png')); ?>">DODO
                                        </option>
                                        <option value="COMP" data-icon-src="<?php echo e(asset('assets/images/currency/COMP.png')); ?>">COMP
                                        </option>
                                        <option value="DAO" data-icon-src="<?php echo e(asset('assets/images/currency/DAO.png')); ?>">DAO
                                        </option>
                                    </select>
                                </div>
                            </div>
                            <p class="calculate__block-value-label"><?php echo e(__("Average Income Per Year")); ?></p>
                            <p class="calculate__block-value"><?php echo e(__("apy_DeFi")); ?></p>
                            <a href="<?php echo e(route('investplan.stacking')); ?>" class="btn btn--primary-gr calculate__btn"><?php echo e(__("Invest now")); ?></a>
                        </div>
                        <div class="calculate__block-col">
        ...
        <div class="container">
            <div class="trading-bot__row">
                <div class="trading-bot__content">
                    <h2 class="trading-bot__title title"><span class="color-primary"><?php echo e(__("DeFi-")); ?> <?php echo e(__('staking')); ?></span> <?php echo e(__("Investment strategy")); ?></h2>
                    <div class="trading-bot__text typography">
                        <p><?php echo __("inv_strategy1"); ?> </p>
                        <p><?php echo __("inv_strategy2"); ?></p>
                        <p><?php echo __("inv_strategy3"); ?></p>
                    </div>
...
<?php echo $__env->make('layouts.front_app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/www-root/data/www/apy-wallet.com/resources/views/pages/defistaking.blade.php ENDPATH**/ ?>
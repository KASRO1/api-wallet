<div class="calculate__field field">
    <div class="field-payment">
        <div class="field-payment__icon">
            <img src="assets/images/currency/BTC.svg" alt="" width="32" height="32" style="width: 100%; height: 100%">
        </div>
        <select class="js-select-payment" name="currency" id="PSys">
            ...
            <!-- <option value="17" data-icon-src="assets/images/currency/USDC.svg">USDC
                (ERC20)
            </option>
            <option value="DAI" data-icon-src="<?php echo e(asset('assets/images/currency/DAI.svg')); ?>">DAI
                (ERC20)
            </option> -->
...
</div><?php /**PATH /Users/nikita/PhpstormProjects/api-wallet/resources/views/cabinet/new/deposits/_currencySelect.blade.php ENDPATH**/ ?>
...
<section id="invest-ftx">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <h1 class="section__heading py-4 mb-4"><span class="c-violet"><?php echo e(__("DeFi staking")); ?></span></h1>
            </div>
        </div>
        <form action="<?php echo e(route('cabinet.deposits.store')); ?>" method="POST">
            <?php echo csrf_field(); ?>
            <input type="text" hidden name="pack" value="defi-staking">
            <div class="row">
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    <?php echo $__env->make('cabinet.new.deposits._defiCurrencySelect', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                </div>
            </div>
            <div class="row">
...
<?php echo $__env->make('layouts.cabinet', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/www-root/data/www/apy-wallet.com/resources/views/cabinet/new/deposits/stacking.blade.php ENDPATH**/ ?>